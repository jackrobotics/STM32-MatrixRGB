...
DigitalOut LED_SLB(A2);
DigitalOut LED_SDAA(D7),LED_SCLL(D6);
BusOut lineRGB(D8,D9,D10,D11,D12,D13,D3,D4);

#define open_line0  {lineRGB=0x01;}
#define open_line1  {lineRGB=0x02;}
#define open_line2  {lineRGB=0x04;}
#define open_line3  {lineRGB=0x08;}
#define open_line4  {lineRGB=0x10;}
#define open_line5  {lineRGB=0x20;}
#define open_line6  {lineRGB=0x40;}
#define open_line7  {lineRGB=0x80;}
#define close_all_line  {lineRGB=0x00;}

unsigned char dots[8][8][3] = {0};
unsigned char dotsTmp[8][8][3] = {0};
//dots matrix
//[8]:Row:8 row in LED plane
//[8]:Column:8 column in one row
//[3]:Color:RGB data: 0 for Red; 1 for green, 2 for Blue

///////////////////////////////////////////////////////////////// Define value of buffer
...
void DispChar(char chr,unsigned char R,unsigned char G,unsigned char B)
{
